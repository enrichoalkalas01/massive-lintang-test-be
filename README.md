# Massive Music Technical Assesment

1. Clone this repo.

    ```bash
    git clone https://gitlab.com/lintangwisesa1/massive-music-test.git
    ```

2. Setup & run the project.

    ```bash
    $ cd massive_music_assesment
    $ npm i
    ```
    ...
    ```env
    PORT=2611
    JWT_KEY=L1n+@N9w15es4Jwt
    JWT_ALGO=HS256
    JWT_ISSUER=MassiveMusic
    ```
...
3. Import `Massive Music Test.postman_collection.json` into Postman to test locally.
